  ...
  void _initializeFormData() {
    if (widget.membro != null) {
      ...
      _formData = Membro(
        ...
        atuacaoCD: m.atuacaoCD,
        atuacaoCF: m.atuacaoCF,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(label: 'Atuação CD', initialValue: _formData.atuacaoCD, onSaved: (v) => _formData.atuacaoCD = v!),
            _buildTextField(label: 'Atuação CF', initialValue: _formData.atuacaoCF, onSaved: (v) => _formData.atuacaoCF = v!),
